...
class USGSClient(FDSNClient):
    ...
    def get_params(self, start_time, end_time, min_magnitude, max_magnitude, min_latitude=None, max_latitude=None, 
        ...
        logger.debug("Generating request parameters:")
        logger.debug(f"start_time: {start_time}")
        logger.debug(f"end_time: {end_time}")
        logger.debug(f"min_magnitude: {min_magnitude}")
        logger.debug(f"max_magnitude: {max_magnitude}")
        logger.debug(f"min_latitude: {min_latitude}")
        logger.debug(f"max_latitude: {max_latitude}")
        logger.debug(f"min_longitude: {min_longitude}")
        logger.debug(f"max_longitude: {max_longitude}")
        logger.debug(f"min_depth: {min_depth}")
